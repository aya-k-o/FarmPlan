...
| 画面 | 説明 |
|---|---|
| ホーム | 栽培中・計画済み区画数、農作業タスク管理、昨年の今頃の作業を表示 |
...
- **栽培メモ**：植え付け時にメモを記録。栽培記録画面からもインライン編集可能
- **農作業タスク管理**：期限付きタスクを登録。完了記録を保持し、昨年の同時期の作業をホームに表示
...
> ※ デモ環境は **https://ayako-k.com/farmplan/login.php** で公開中です。ローカル環境構築なしですぐ試せます。
